...
function edit_jurusan(jurusan_id)
{
    save_method = 'update';
    $('#form')[0].reset(); // reset form on modals
    $('.form-group').removeClass('has-error'); // clear error class
    ...
    $.ajax({
        url : "<?php echo site_url('jurusan/ajax_edit/')?>/" + jurusan_id,
        type: "GET",
        dataType: "JSON",
...
function delete_jurusan(jurusan_id)
{
    if(confirm('Are you sure delete this data?'))
    {
        // ajax delete data to database
        $.ajax({
            url : "<?php echo site_url('jurusan/ajax_delete')?>/"+jurusan_id,
            type: "POST",
            dataType: "JSON",
            success: function(data)
            {
        ...
        <div class="modal-content">
            ...
            <div class="modal-body form">
                <form action="#" id="form" class="form-horizontal">
                    <input type="hidden" value="" name="jurusan_id"/> 
                    <div class="form-body">
                        <div class="form-group">
                            <label class="control-label col-md-3">Nama Jurusan</label>
                            <div class="col-md-9">
                                <input name="nama_jurusan" placeholder="Nama Jurusan" class="form-control" type="text">
